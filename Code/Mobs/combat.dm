...
mob
/mob/proc/KnockBack(var/Dis,var/DIR)
...
/mob/proc/ArrowDamage(var/DMG,var/obj/A)
	if(src.Humanoid)
		var/HLeftArm = 0
		var/HRightArm = 0
		var/HLeftLeg = 0
...
/mob/proc/CheckWeaponDura(var/obj/W)
	if(W)
		if(W == src.Weapon)
			if(W.Dura <= 0)
				W.Dura = 0
...
/mob/proc/CombatSkillTransfer(var/mob/Learner,var/Extra)
...
/mob/proc/GainStats(var/Divide,var/AddInt)
...
/mob/proc/ApplyCombatSkills(var/obj/HasWep)
	if(HasWep)
		var/Dual = 0
...
/mob/proc/DetermineWeaponSkill(var/obj/Wep)
	if(Wep == null)
...
/mob/proc/Combat(var/obj/MainWeapon)
	var/IsMob = 0
	if(src.Target)
		if(ismob(src.Target))
			IsMob = 1
...
/mob/proc/Affliction(var/A,var/mob/Victim)
	if(A == null)
		return
	if(Victim == null)
		return
...
//Affliction Codes
/mob/proc/Illness(var/SeverityFactor)
	spawn(rand(200,1000))
		if(src && src.Dead == 0)
...
/mob/proc/FireRanged(var/turf/T)

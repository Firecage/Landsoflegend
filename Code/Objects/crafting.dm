/mob/proc/CraftBoneArmour(var/obj/Bone,var/obj/W)
	if(Bone && W)
		var/AddedDefence = 0
		var/AddedDura = 0
		var/Qual = null
...
/mob/proc/CraftLeatherArmour(var/obj/Leather,var/obj/W)
	if(Leather && W)
		var/AddedDefence = 0
		var/AddedDura = 0
		var/Qual = null
...
/mob/proc/CraftArmour(var/obj/Ingot,var/obj/W)
	if(Ingot && W)
		var/AddedDefence = 0
		var/AddedDura = 0
		var/Qual = null
...
/mob/proc/CraftWeapon(var/obj/Ingot,var/obj/W)
	if(Ingot && W)
		var/AddedDMG = 0
		var/AddedDura = 0
		var/Qual = null

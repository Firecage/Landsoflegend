/obj/Items/Weapons/Swords
	ObjectType = "Sword"

/obj/Items/Weapons/Swords/Click()
...
/obj/Items/Weapons/Swords/DemonicSword
	icon = 'weapons.dmi'
...
/obj/Items/Weapons/Swords/DemonicSword/New()
	src.icon_state = src.CarryState
	src.layer = 4
...
/obj/Items/Weapons/Swords/BroadSword/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Weapons/Swords/Scimitar
	icon = 'weapons.dmi'
	icon_state = "scimitar"
	EquipState = "scimitar"
	CarryState = "scimitar"
...
/obj/Items/Weapons/Swords/Scimitar/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Weapons/Swords/Sabre
	icon = 'weapons.dmi'
	icon_state = "sabre"
	EquipState = "sabre"
	CarryState = "sabre"
...
/obj/Items/Weapons/Swords/Sabre/New()
		src.icon_state = src.CarryState
		src.layer = 4

/obj/Items/Weapons/Swords/LongSword
	icon = 'weapons.dmi'
	icon_state = "sword"
	EquipState = "sword"
	CarryState = "sword"
...
/obj/Items/Weapons/Swords/LongSword/New()
		src.icon_state = src.CarryState
		src.layer = 4

/obj/Items/Weapons/Swords/Saw
	icon = 'tools.dmi'
	icon_state = "saw"
	EquipState = "saw"
	CarryState = "saw"
...
/obj/Items/Weapons/Swords/Saw/New()
	src.icon_state = src.CarryState
	src.layer = 4

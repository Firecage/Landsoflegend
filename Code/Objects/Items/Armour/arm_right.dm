/obj/Items/Armour/RightArm

/obj/Items/Armour/RightArm/Click()
...
/obj/Items/Armour/RightArm/BoneRightGauntlet
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/BoneRightGauntlet/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/LeatherGloveRight
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/LeatherGloveRight/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/PriestsRightGauntlet
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/PriestsRightGauntlet/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/Glove_of_Corruption
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/Glove_of_Corruption/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/InquisitorsRightGauntlet
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/InquisitorsRightGauntlet/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/GiantChainGloveRight
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/GiantPlateGloveRight
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/GiantPlateGloveRight/New()
	src.icon_state = src.CarryState
	src.layer = 4


/obj/Items/Armour/RightArm/SmallPlateGauntletRight
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/SmallPlateGauntletRight/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/RatPlateGauntletRight
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/RatPlateGauntletRight/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/RightArm/PlateGauntletRight
	icon = 'equipment.dmi'
...
/obj/Items/Armour/RightArm/PlateGauntletRight/New()
	src.icon_state = src.CarryState
	src.layer = 4

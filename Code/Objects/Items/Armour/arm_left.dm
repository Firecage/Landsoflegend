/obj/Items/Armour/LeftArm

/obj/Items/Armour/LeftArm/Click()
...
/obj/Items/Armour/LeftArm/BoneLeftGauntlet
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/BoneLeftGauntlet/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/LeatherGloveLeft
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/LeatherGloveLeft/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/PriestsLeftGauntlet
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/PriestsLeftGauntlet/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/InquisitorsLeftGauntlet
	icon = 'equipment.dmi'
	...
	Delete = 1
	BaseMaterial = "Metal"
/obj/Items/Armour/LeftArm/InquisitorsLeftGauntlet/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/RatPlateGauntletLeft
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/RatPlateGauntletLeft/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/SmallPlateGauntletLeft
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/SmallPlateGauntletLeft/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/PlateGauntletLeft
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/PlateGauntletLeft/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/GiantChainGloveLeft
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/GiantChainGloveLeft/New()
	src.icon_state = src.CarryState
	src.layer = 4

/obj/Items/Armour/LeftArm/GiantPlateGloveLeft
	icon = 'equipment.dmi'
...
/obj/Items/Armour/LeftArm/GiantPlateGloveLeft/New()
	src.icon_state = src.CarryState
	src.layer = 4
